    ...
    function get_score()
    {
        ...
        do{
            ...
            else
            {
    			...
    			{
					$base = basename($resFile, ".txt");
					$sql = "select * from judge_res where file REGEXP $base";
                    ...
                    $sql = "update judge_res set result=\"$resStr\" where id=$id and number=$number and mediafile=\"$mediafile\";";
                    echo $sql."\n";
                    ...
                    else
                    {
						...
						if(!(isset($new_xml->fscore) && (float)$new_xml->fscore < 0)  && !(isset($new_xml->score) && (float)$new_xml->score < 0) && !(isset($new_xml->motp) && (float)$new_xml->motp - 0 < 0.0001))
						{
							...
							else
							{
								...
								if((isset($old_xml->fscore) && (float)$old_xml->fscore < (float)$new_xml->fscore) ||
									(isset($old_xml->mota) && (float)$old_xml->mota < (float)$new_xml->mota && (float)$new_xml->motp - 0 < 0.0001))
								{
